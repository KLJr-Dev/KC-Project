...
/**
 * Re-applies demo storagePath fix when DB was polluted by host-path e2e runs.
 * Idempotent: always sets paths relative to process.cwd()/uploads.
 */
export class RepairDemoStoragePathsAgain1771440000003 implements MigrationInterface {
