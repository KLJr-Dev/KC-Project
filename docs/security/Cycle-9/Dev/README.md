# Cycle-9 — Dev workspace

**Status:** **SoftDev integrated on `dev`** — pair **`v1.6.0`** → **`v2.6.0`** ([ADR-038](../../../decisions/ADR-038-cycle-9-onboarding-defence-pair.md)).
...
| [v1.6.0-ground-truth.md](v1.6.0-ground-truth.md) | Examiner only (flags filled) |
| [v1.6.0-player-brief.md](v1.6.0-player-brief.md) | Progressive hints |
| [v1.6.0-gap-closure.md](v1.6.0-gap-closure.md) | v2.5.0 insecurity → C9 role map (~80%) |

**Skin:** [ADR-037](../../../decisions/ADR-037-immersion-northwind-product-face.md) — Northwind on both tips.  
**No plant overlay compose** — plants live on insecure tip; Blue removes on `v2.6.0`.
