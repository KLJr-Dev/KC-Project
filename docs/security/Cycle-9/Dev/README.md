...
**Status:** **P0 design** — baseline tip **`v2.5.0`**; pair **`v1.6.0`** → **`v2.6.0`** ([ADR-038](../../../decisions/ADR-038-cycle-9-onboarding-defence-pair.md)).
...
| [v1.6.0-player-brief.md](v1.6.0-player-brief.md) | Progressive hints (draft) |
