...
**Status:** **Cycle closed** — insecure `v1.5.0` / `ctf/v1.5.0` frozen; secure **`v2.5.0`** tagged on `main` ([gate](../../release/v2.5.0-secure-ready.md)).

| Doc | Role |
|-----|------|
| [cycle-8-decisions.md](cycle-8-decisions.md) | Locked product / packaging / DAG / ledger / pedagogy / skin |
| [v1.5.0-box-plan.md](v1.5.0-box-plan.md) | Player path + ceiling |
...
| [v1.5.0-execution-plan.md](v1.5.0-execution-plan.md) | Feature-lane runbook P0–P7 (**complete**) |
