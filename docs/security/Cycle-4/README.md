...
**Status:** Tag **`v1.2.0`** shipped · **Red complete (3/3)** · Blue next · [ADR-033](../../decisions/ADR-033-cycle-4-softdev-version-pair.md)  
...
| PenTest | Red (F1–F3; foothold only) | **Complete** — [writeup](PenTest/v1.2.0-writeup.md) |
| **`remediation/v2.2.0`** → tag **`v2.2.0`** | Harden Notes; no default SSH | **Next** |
