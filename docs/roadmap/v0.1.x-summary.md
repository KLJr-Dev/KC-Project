...
|---|----------|-----|-------------|------------|
| 1 | Sequential predictable user IDs | CWE-330 | A01:2025 | v0.1.0 |
| 2 | Plaintext password storage | CWE-256 | A07:2025 | v0.1.1 |
| 3 | Leaky duplicate error (email in 409 message) | CWE-209 | A07:2025 | v0.1.1 |
| 4 | Plaintext password comparison | CWE-256 | A07:2025 | v0.1.2 |
| 5 | Distinct auth errors enable user enumeration | CWE-204 | A07:2025 | v0.1.2 |
| 6 | Weak JWT secret (hardcoded `'kc-secret'`) | CWE-798 | A04:2025 | v0.1.3 |
| 7 | JWT signed with weak HS256 algorithm | CWE-347 | A04:2025 | v0.1.3 |
| 8 | No token expiration (no `exp` claim) | CWE-613 | A07:2025 | v0.1.3 |
| 9 | Guard does not check user still exists | CWE-613 | A07:2025 | v0.1.3 |
| 10 | Token stored in localStorage (XSS-accessible) | CWE-922 | A07:2025 | v0.1.3 |
| 11 | Missing authorization on /auth/me | CWE-862 | A01:2025 | v0.1.3 |
| 12 | Permissive CORS (all origins) | CWE-942 | A02:2025 | v0.1.3 |
| 13 | Cleartext transport (HTTP, no TLS) | CWE-319 | A04:2025 | v0.1.3 |
| 14 | Source code comments in CSR bundle | CWE-615 | A02:2025 | v0.1.3 |
| 15 | Cosmetic logout (no server-side invalidation) | CWE-613 | A07:2025 | v0.1.4 |
| 16 | Token replay after logout | CWE-613 | A07:2025 | v0.1.4 |
| 17 | No rate limiting on auth endpoints | CWE-307 | A07:2025 | v0.1.5 |
| 18 | Weak password requirements | CWE-521 | A07:2025 | v0.1.5 |
