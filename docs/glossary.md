...
| **XSS** | Cross-Site Scripting. Injecting malicious scripts into pages viewed by others (CWE-79). SoftDev tip (`v1.2.0`): Notes HTML + unsafe markdown (+ inline SVG/HTML attachments). | [Cycle-4](security/Cycle-4/README.md) |
...
| **Module** | A NestJS organisational unit grouping controllers/services. SoftDev tip: 6 domain modules (Users, Auth, Files, Sharing, Admin, **Notes**) + AppModule. | [ADR-007](decisions/ADR-007-five-domain-split.md), [ADR-033](decisions/ADR-033-cycle-4-softdev-version-pair.md) |
...
| **SoftDev tip** | Intentional insecure product tip on `main` from SoftDev rails (Cycle-4 Notes+SSH). Pin tag `v2.1.0` for hardened demos until `v2.2.0`. | [ADR-033](decisions/ADR-033-cycle-4-softdev-version-pair.md) |
...
| **Notes** | Sixth product domain: user-owned notes, search, mod flag, optional attachment. SoftDev XSS sinks on insecure tip. | [Cycle-4](security/Cycle-4/README.md) |
...
| **Cycle-4** | SoftDev pair: `v1.2.0` (Notes XSS + SSH) → `v2.2.0` (harden Notes; no default SSH). | [ADR-033](decisions/ADR-033-cycle-4-softdev-version-pair.md) |
