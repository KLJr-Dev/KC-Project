...
**Current tip on `main`:** secure **`v2.4.0`** (Ops Documents path-confined; Cycle-7 overlays unpublished) — [Cycle-7](../security/Cycle-7/README.md) · [ADR-035](../decisions/ADR-035-cycle-7-multi-service-pair.md).  
**Insecure replay:** tag/`ctf/v1.4.0` (+ Cycle-7 compose) · tag/`ctf/v1.3.0` · tag/`ctf/v1.2.0` · [ADR-032](../decisions/ADR-032-post-v2.1.0-versioning.md) for CTF-only cycles.
