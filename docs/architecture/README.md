...
**Current tip on `main`:** secure **`v2.5.0`** (Cycle-8 Northwind Intake — **Closed**) — [Cycle-8](../security/Cycle-8/README.md) · [ADR-036](../decisions/ADR-036-cycle-8-intake-tool-chain-pair.md).  
**Insecure replay:** tag/`ctf/v1.5.0` (+ Cycle-8 compose) · tag/`ctf/v1.4.0` · tag/`ctf/v1.3.0` · tag/`ctf/v1.2.0` · [ADR-032](../decisions/ADR-032-post-v2.1.0-versioning.md) for CTF-only cycles.
